...
flutter build apk --target-platform android-arm64,android-arm --${MODE} --obfuscate --release --split-debug-info ./split-debug-info 
flutter build apk --split-per-abi --target-platform android-arm64,android-arm --${MODE} --obfuscate --release --split-debug-info ./split-debug-info
flutter build appbundle --target-platform  android-arm64,android-arm --${MODE} --obfuscate --release --split-debug-info ./split-debug-info
